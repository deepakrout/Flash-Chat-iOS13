...
class ChatViewController: UIViewController {
    ...
    var messages: [Message] = [
        Message(sender: "dr@yahoo.com", body: "Hi"),
        Message(sender: "rt@yahoo.com", body: "Hello!"),
        Message(sender: "dr@yahoo.com", body: "What's up?")
    ]
    ...
    func loadMessages() {
        ...
        db.collection(K.FStore.collectionName)
            ...
            .addSnapshotListener{ (querySnapshot, error) in
                if let e = error {
                    print("Error reading data: \(e.localizedDescription)")
                } else {
                    self.messages = []
